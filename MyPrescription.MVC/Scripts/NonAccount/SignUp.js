                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data == true) {
                                ...
                                $("#popover-emailCheck-content").html("<div class='text-warning'>" +
                                    "Some has already registered using that Email-Id. " +
                                    "<br />If that's you, click on <a href='SignIn.aspx'>LogIn</a> " +
                                    "to head back to the LogIn page. <br />Otherwise use a fresh Email-Id.</div>");
                                $('#signupEmail').popover('show');
                                isEmailValid = false;
                            }
                        },
